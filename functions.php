...
function html5blank_styles()
{
    ...
    wp_register_style('bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap.css');
    wp_enqueue_style('bootstrap'); // Enqueue it!

    wp_register_style('bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap-reboot.css');
    wp_enqueue_style('bootstrap'); // Enqueue it!

    wp_register_style('bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap-grid.css');
    wp_enqueue_style('bootstrap'); // Enqueue it!
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'header-menu' => __('Header Menu', 'html5blank'), // Main Navigation
        'pages-menu' => __('Pages Menu', 'html5blank'),  // Pages navigation
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Sidebar Widget Area', 'html5blank'),
        'description' => __('Widget area for stuff to appear in a block named sidebar', 'html5blank'),
        'id' => 'widget-area-1',
...
function length_callback($length)
{
    return 50;
}
...
function html5wp_excerpt($length_callback = 'length_callback')
{
    global $post;
...
// ================== CUSTOM MCE EDITOR STYLES (VISUAL EDITOR) =========
...
*/
        array(  
            'title' => 'rozhovor - otázka',  
            'block' => 'div',  
            'classes' => 'intQuestion',
            'wrapper' => false,
        ),
        array(  
            'title' => 'rozhovor - resume',  
            'block' => 'div',  
            'classes' => 'intPersonResume',
            'wrapper' => false,
        ),
    );  
